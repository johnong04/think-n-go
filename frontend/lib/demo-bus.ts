...
export type BusEvent =
  | { type: "merchant:bnpl-funded";          payload: { escrowId: string; amount: number; bnpl: number; cash: number } }
  ...
  | { type: "swarm:phase-changed";           payload: { phase: string; scenario: string | null } }
